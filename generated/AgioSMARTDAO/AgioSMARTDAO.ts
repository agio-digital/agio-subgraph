...
export class AgioSMARTDAO__proposalVotesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class AgioSMARTDAO extends ethereum.SmartContract {
  static bind(address: Address): AgioSMARTDAO {
    return new AgioSMARTDAO("AgioSMARTDAO", address);
  }
  ...
  proposalVotes(proposalId: BigInt): AgioSMARTDAO__proposalVotesResult {
    let result = super.call(
      "proposalVotes",
    ...
    return new AgioSMARTDAO__proposalVotesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_proposalVotes(
    proposalId: BigInt
  ): ethereum.CallResult<AgioSMARTDAO__proposalVotesResult> {
    let result = super.tryCall(
      "proposalVotes",
      "proposalVotes(uint256):(uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(proposalId)]
    ...
    return ethereum.CallResult.fromValue(
      new AgioSMARTDAO__proposalVotesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
